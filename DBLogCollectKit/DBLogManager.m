...
- (void)saveCriticalSDKRunData:(NSString *)string {
    ...
    NSString *dateStr = [DBFDateFormatter currentDateString];
    ...
    string = [NSString stringWithFormat:@"\n%@: %@\n",[DBFDateFormatter currentTimeString],string];
...
- (void)backFileWithLogFilePath:(NSString *)logFilePath {
    ...
    BOOL isDirectory;
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSString *backUpFilePath = self.backUpFilePath;
...
- (NSString *)filePath {
    if (!_filePath) {
        _filePath = [self getDocPathWithFileName:KLogFileName];
    }
    return _filePath;
}
...
- (NSString *)backUpFilePath {
    if (!_backUpFilePath) {
        _backUpFilePath = [self getDocPathWithFileName:KBackUpFileName];
    }
